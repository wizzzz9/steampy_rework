...
class ConfirmationExecutor:
    ...
    def _fetch_confirmations_page(self) -> requests.Response:
        ...
        response = self._session.get(self.CONF_URL + '/conf', params=params, headers=headers, proxies=self._proxy)
    ...
    def _fetch_confirmation_details_page(self, confirmation: Confirmation) -> str:
        ...
        params = self._create_confirmation_params(tag)
        response = self._session.get(self.CONF_URL + '/details/' + confirmation.id, params=params, proxies=self._proxy)
